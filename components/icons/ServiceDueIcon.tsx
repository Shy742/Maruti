...
export const ServiceDueIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        ...
        <text x="12" y="14" textAnchor="middle" fontSize="5" fontWeight="bold" fill="currentColor">000</text>
    </svg>
);
